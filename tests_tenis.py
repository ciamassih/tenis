...
class PartidoTenis(unittest.TestCase):
    ...
    def test_puntaje_advantage_jugador_2(self):
        score1 = Score(40)
        score2 = Score(40)
        score2.anotacion(score2)
        self.assertEqual(score1.puntos, 40)
        self.assertEqual(score2.puntos, "Advantage")

    def test_ganando_set_jugador1_despues_de_deuce(self):
        score1 = Score("Advantage")
        score2 = Score(40)
        score1.ganarsetadvantage(score1, score2)
        self.assertEqual(score1.puntos, "Set ganado por el jugador 1")

    def test_ganando_set_jugador2_despues_de_deuce(self):
        score1 = Score(40)
        score2 = Score("Advantage")
        score2.ganarsetadvantage(score1, score2)
        self.assertEqual(score2.puntos, "Set ganado por el jugador 2")

    def test_advantage_jugador1_volviendo_a_deuce(self):
        score1 = Score("Advantage")
        score2 = Score(40)
        score2.anotacion(score2)
        score2.deuce(score1, score2)
        self.assertEqual(score1.puntos, "Deuce")
        self.assertEqual(score2.puntos, "Deuce")